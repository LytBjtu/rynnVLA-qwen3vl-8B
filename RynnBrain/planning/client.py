        ...
        **Workflow:**
        ...
        with gr.Row():
            with gr.Column(scale=1):
                ...
                camera_feed = gr.Image(label="Live Feed", streaming=True, sources="webcam")  # Modified code
        ...
        stream_timer = gr.Timer(value=0.1 if CAMERA_AVAILABLE else 99999, active=CAMERA_AVAILABLE)
        stream_timer.tick(stream_video, None, camera_feed)
...
if __name__ == "__main__":
    ...
    demo.queue().launch(server_name="0.0.0.0", server_port=args.port, show_error=True, theme=gr.themes.Soft())